...
format: pdf
thanks: "Code and data are available at: https://github.com/TEJMaster/STA302-Mini-Essay2"
author: "Terry Tu"
...
write_csv(x=clean_subway_delay_data, 
          file="../inputs/data/cleaned_subway_delay_data_2023.csv")
```
